...
if (mark.bmi > john.bmi) {
    ...
    //console.log("Mark's BMI is higher than John's, expecting Mark to win")

}
else if (john.bmi > mark.bmi) {
    console.log(`${john.fullName} BMI (${john.bmi}) is higher than the ${mark.fullName} BMI(${mark.bmi}) `);
}
